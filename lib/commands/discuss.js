...
async function discuss(message) {
  ...
  console.log(chalk.gray('  1. Read the current discussion: ') + chalk.cyan(`.teamwerx/research/${goal}/discussion.md`));
  console.log(chalk.gray('  2. Append the new message to the discussion'));
