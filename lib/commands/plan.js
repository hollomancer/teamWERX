...
async function plan(goalName) {
  ...
  console.log(chalk.gray('  2. Review prior research sessions in: ') + chalk.cyan(`.teamwerx/research/${goal}/session-*/`));
  console.log(chalk.gray('  3. Read the discussion log: ') + chalk.cyan(`.teamwerx/research/${goal}/discussion.md`));
  console.log(chalk.gray('  4. Generate a detailed task list without deleting earlier plans (append or version updates as needed)'));
