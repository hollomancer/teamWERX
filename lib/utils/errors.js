...
const ERROR_MESSAGES = {
  NOT_INITIALIZED: 'teamWERX is not initialized. Please run \'teamwerx init\' first.',
  ...
  FILE_OPERATION_FAILED: (operation, path) => `Failed to ${operation} file: ${path}`,
 ...
 */
function handleError(error, context = '', exitCode = ERROR_CODES.GENERAL_ERROR) {
